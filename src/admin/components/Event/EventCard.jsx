      ...
      <div className="mt-6 pt-4 border-t border-stone-100 space-y-4">
        {getNextStateOptions().length > 0 && (
          <select
            ...
            className="w-full bg-stone-50 border border-stone-200 text-stone-700 py-2 px-3 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 cursor-pointer"
            defaultValue=""
          >
        ...
        <div className="flex gap-2">
          <button 
            onClick={onEdit} 
            className="flex-1 flex items-center justify-center gap-2 py-2 px-3 bg-white border border-stone-200 text-stone-600 rounded-lg hover:bg-stone-50 hover:text-amber-700 transition-colors text-sm font-medium"
          >
          ...
          <button 
            onClick={onDelete} 
            className="flex-1 flex items-center justify-center gap-2 py-2 px-3 bg-white border border-red-200 text-red-600 rounded-lg hover:bg-red-50 transition-colors text-sm font-medium"
          >
