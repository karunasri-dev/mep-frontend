    ...
    <header className="relative w-full h-[400px] overflow-hidden text-white shadow-lg">
      ...
      <div className="relative container mx-auto px-4 py-6 z-10">
        <div className="flex items-center justify-center space-x-12 mt-10">
          ...
          <div>
            <h1 className="text-7xl font-bold tracking-wide text-amber-700">
              Mana Edla Pandalu
            </h1>
          </div>
        ...
        <div className="mt-10 text-center">
          <p className="text-amber-700 font-semibold text-xl mt-1 bg-amber-200 px-4 py-2 rounded-full inline-block shadow-lg">
